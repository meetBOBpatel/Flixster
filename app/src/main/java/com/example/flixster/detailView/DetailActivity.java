package com.example.flixster.detailView;
...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    public static final String YOuTUBE_API_KEY = "AIzaSyC-Ts3O3EbB9SQumkebNTMOvJrcF-Q-lZ8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Inside the DetailedActivity");
    ...
    private void initializeYoutbe(String youtubeKey) {
